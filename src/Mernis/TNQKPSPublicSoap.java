...
public class TNQKPSPublicSoap
{
    ...
    public TNQKPSPublicSoap(){}

    public TNQKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public TNQKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TNQExtendedSoapSerializationEnvelope envelope= new TNQExtendedSoapSerializationEnvelope(TNQExtendedSoapSerializationEnvelope.VER11);
